    ...
    return (
        <div className="p-4 md:p-8 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <div>
                        <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Cancel Orders</h1>
                        <p className="text-gray-600 mt-1">View all Cancel customer orders</p>
                    </div>
                </motion.div>
                ...
                {filteredOrders.length > 0 && (
                    ...
                    >
                        <div>
                            ...
                            <span className="font-medium">{orders.length}</span> Cancel orders
                        </div>
                    </motion.div>
                )}
            </div>
